---
layout: tool-doc
title: "spokenform kokorog2p migration boundary"
permalink: /tools/spokenform/main/migration-kokorog2p/
...
<section id="kokorog2p-migration-boundary">
<h1>kokorog2p migration boundary</h1>
<p>spokenform can serve a downstream adapter for one selected language run. Call
<code class="docutils literal notranslate"><span class="pre">prepare_for_kokorog2p()</span></code> (or pass <code class="docutils literal notranslate"><span class="pre">PreparationConfig.for_kokorog2p()</span></code>), preserve
caller override spans with <code class="docutils literal notranslate"><span class="pre">ProtectedSpan</span></code>, use <code class="docutils literal notranslate"><span class="pre">PreparedText.source_edits</span></code> and
...
<th class="head"><p>Suitable for spokenform</p></th>
<th class="head"><p>Keep downstream</p></th>
