---
layout: tool-doc
title: "spokenform 0.2.3 downstream handoff"
permalink: /tools/spokenform/main/kokorog2p-0.2.3-handoff/
...
<section id="spokenform-0-2-3-downstream-handoff">
...
<li><p>remove the local <code class="docutils literal notranslate"><span class="pre">eins</span> <span class="pre">Kubikmeter</span></code> compatibility regex;</p></li>
<li><p>add direct-vs-public German extended-quantity parity coverage;</p></li>
<li><p>run the complete seven-language migration suite; and</p></li>
<li><p>release only after those checks pass against the released package.</p></li>
</ol>
<p>The spokenform-side real run-level German gate is in
<code class="docutils literal notranslate"><span class="pre">tests/test_real_kokorog2p_integration.py</span></code> and covers area, volume, speed,
