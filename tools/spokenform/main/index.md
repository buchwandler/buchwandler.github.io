...
layout: tool-doc
title: "spokenform"
permalink: /tools/spokenform/main/
...
<section id="spokenform">
<h1>spokenform</h1>
<p><code class="docutils literal notranslate"><span class="pre">spokenform</span></code> is a single-language written-to-spoken text normalizer for speech
...
<li class="toctree-l2"><a class="reference internal" href="languages/#russian-scope">Russian scope</a></li>
<li class="toctree-l2"><a class="reference internal" href="languages/#identifier-rules">Identifier rules</a></li>
...
<li class="toctree-l2"><a class="reference internal" href="quickstart/#vietnamese">Vietnamese</a></li>
<li class="toctree-l2"><a class="reference internal" href="quickstart/#thai">Thai</a></li>
<li class="toctree-l2"><a class="reference internal" href="quickstart/#configuration-object">Configuration object</a></li>
</ul>
</li>
...
<li class="toctree-l2"><a class="reference internal" href="spacy/#required-token-contract">Required token contract</a></li>
<li class="toctree-l2"><a class="reference internal" href="spacy/#error-behavior">Error behavior</a></li>
</ul>
</li>
...
<section id="scope">
<h2>Scope</h2>
<p>The package accepts plain text and one selected processing language. Language
detection, mixed-language segmentation, SSMD or other markup parsing, and phoneme
generation are intentionally outside the package.</p>
</section>
</section>
</div>
