---
layout: tool-doc
title: "spokenform Installation"
permalink: /tools/spokenform/main/installation/
...
<p>For development from a checkout:</p>
...
<p>On Windows, activate with <code class="docutils literal notranslate"><span class="pre">.venv\Scripts\activate</span></code>.</p>
</section>
<section id="optional-spacy-support">
<h2>Optional spaCy support</h2>
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>python<span class="w"> </span>-m<span class="w"> </span>pip<span class="w"> </span>install<span class="w"> </span><span class="s2">&quot;spokenform[spacy]&quot;</span>
python<span class="w"> </span>-m<span class="w"> </span>spacy<span class="w"> </span>download<span class="w"> </span>de_core_news_sm
</pre></div>
</div>
<p>The spaCy library and trained pipeline are separate packages. Installing the
<code class="docutils literal notranslate"><span class="pre">spacy</span></code> extra does not install or download a language pipeline.</p>
</section>
<section id="documentation">
<h2>Documentation</h2>
<p>The documentation source uses MyST Markdown. Install the supplied requirements
file together with the project:</p>
...
<p>Install the optional provider and an explicit local runtime artifact:</p>
...
lexhint<span class="w"> </span>dataset<span class="w"> </span>download<span class="w"> </span>en<span class="w"> </span>--variant<span class="w"> </span>runtime
</pre></div>
</div>
