...
permalink: /tools/spokenform/architecture/
nav_tool: spokenform
...
<li><p>expand abbreviations and numeric units with <code class="docutils literal notranslate"><span class="pre">abbr2words</span></code>;</p></li>
<li><p>verbalize supported numeric forms with <code class="docutils literal notranslate"><span class="pre">num2words</span></code>;</p></li>
<li><p>normalize Unicode and whitespace;</p></li>
<li><p>restore protected text and compose stage offset maps.</p></li>
</ol>
<p>Each stage records its input, output, edits, and mapped edits. The final
...
<code class="docutils literal notranslate"><span class="pre">spoken_text</span></code> coordinates.</p>
