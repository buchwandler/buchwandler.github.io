---
layout: tool-doc
title: "abbr2words Installation"
permalink: /tools/abbr2words/main/installation/
...
<p><code class="docutils literal notranslate"><span class="pre">abbr2words</span></code> has no runtime dependencies. It supports Python 3.10 through Python
3.14, subject to the release matrix maintained by the project.</p>
</section>
...
<h2>Documentation</h2>
<p>Documentation dependencies are separate from the runtime package:</p>
<div class="highlight-console notranslate"><div class="highlight"><pre><span></span><span class="go">python -m pip install -r docs/requirements.txt</span>
<span class="go">sphinx-build -W --keep-going -b html docs docs/_build/html</span>
</pre></div>
</div>
</section>
</section>
