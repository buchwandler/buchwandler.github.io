---
layout: tool-doc
title: "epub2text Python API"
description: "Python API classes and functions for epub2text"
...
Documented via Sphinx autodoc in the source repository:
- `epub2text.StructuredEpubExtraction`
### TextBlock
...
Documented via Sphinx autodoc in the source repository:
- `epub2text.TextSegment`
### XhtmlFragment

Documented via Sphinx autodoc in the source repository:
- `epub2text.XhtmlFragment`
### ExtractionPolicy

Documented via Sphinx autodoc in the source repository:
- `epub2text.ExtractionPolicy`
### extract_epub_structure

Documented via Sphinx autodoc in the source repository:
- `epub2text.extract_epub_structure`
## Bookmarks
...
Documented via Sphinx autodoc in the source repository:
- `epub2text.BookmarkManager`
## Interactive Reader

### EpubReader

Documented via Sphinx autodoc in the source repository:
- `epub2text.EpubReader`
### ReaderState

Documented via Sphinx autodoc in the source repository:
- `epub2text.ReaderState`
## Text Cleaning

### TextCleaner

Documented via Sphinx autodoc in the source repository:
- `epub2text.TextCleaner`
### clean_text

Documented via Sphinx autodoc in the source repository:
- `epub2text.clean_text`
## Text Formatting

### format_paragraphs

Documented via Sphinx autodoc in the source repository:
- `epub2text.formatters.format_paragraphs`
### format_sentences

Documented via Sphinx autodoc in the source repository:
- `epub2text.formatters.format_sentences`
### format_clauses

Documented via Sphinx autodoc in the source repository:
- `epub2text.formatters.format_clauses`
### split_long_lines

Documented via Sphinx autodoc in the source repository:
- `epub2text.formatters.split_long_lines`
### collapse_paragraph

Documented via Sphinx autodoc in the source repository:
- `epub2text.formatters.collapse_paragraph`
### split_paragraphs

Documented via Sphinx autodoc in the source repository:
- `epub2text.formatters.split_paragraphs`
