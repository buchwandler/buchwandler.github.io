...
<dt>lang: Required default language code for text-to-phoneme conversion.</dt><dd><p>Pass it explicitly for each document, or override it with <code class="docutils literal notranslate"><span class="pre">run(lang=...)</span></code>.
Can be overridden per-segment with SSMD <code class="docutils literal notranslate"><span class="pre">[text]{lang=&quot;fr&quot;}</span></code> syntax.
regular text, bypassing text-to-phoneme conversion. Default: False</p>
</dd>
...
<span class="gp">&gt;&gt;&gt; </span><span class="n">config</span> <span class="o">=</span> <span class="n">GenerationConfig</span><span class="p">(</span><span class="n">lang</span><span class="o">=</span><span class="s2">&quot;en-us&quot;</span><span class="p">,</span> <span class="n">speed</span><span class="o">=</span><span class="mf">1.2</span><span class="p">,</span> <span class="n">pause_mode</span><span class="o">=</span><span class="s2">&quot;manual&quot;</span><span class="p">)</span>
