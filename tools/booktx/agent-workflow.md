...
<li><p>Never edit <code class="docutils literal notranslate"><span class="pre">translations/&lt;profile&gt;/translation-store.json</span></code> directly. If validation flags an old accepted record, use <code class="docutils literal notranslate"><span class="pre">booktx</span> <span class="pre">translate</span> <span class="pre">revise-record</span></code> to fix it.</p></li>
