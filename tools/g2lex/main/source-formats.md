---
layout: tool-doc
title: "g2lex Source formats"
permalink: /tools/g2lex/main/source-formats/
nav_tool: g2lex-main
docs_project: "g2lex"
docs_variant: "main"
docs_ref: "main"
...
<p>G2Lex adapters are intentionally strict and preserve source-specific semantics.
All formats produce the same typed lexicon model, but they do not flatten
features that their source format represents differently.</p>
<table class="docutils align-default">
<thead>
<tr class="row-odd"><th class="head"><p>Format</p></th>
<th class="head"><p>Accepted input</p></th>
<th class="head"><p>Important behavior</p></th>
</tr>
</thead>
<tbody>
...
<tr class="row-odd"><td><p><code class="docutils literal notranslate"><span class="pre">jsonl</span></code></p></td>
<td><p>One JSON record per line</p></td>
<td><p>Records are decoded independently; malformed records are rejected.</p></td>
</tr>
...
<p>Duplicate words are handled by each adapter’s documented source rules. Variant
order is meaningful and is retained. Tags and selectors are represented as typed
values rather than embedded in pronunciation strings.</p>
<p>For the plain two-column <code class="docutils literal notranslate"><span class="pre">tsv</span></code> adapter, every spelling is represented as a tuple
at the exact-value layer, including a spelling with only one physical row. For
example, one <code class="docutils literal notranslate"><span class="pre">Haus</span></code> row becomes <code class="docutils literal notranslate"><span class="pre">(&quot;pronunciation&quot;,)</span></code>, while repeated rows keep
their source order. Use <code class="docutils literal notranslate"><span class="pre">lookup_all()</span></code> or <code class="docutils literal notranslate"><span class="pre">lookup()</span></code> when a consumer needs a
pronunciation tuple or the first pronunciation instead of the exact typed value.</p>
<p>Use the format name with <code class="docutils literal notranslate"><span class="pre">g2lex</span> <span class="pre">pack</span></code>:</p>
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>g2lex<span class="w"> </span>pack<span class="w"> </span>cmudict.dict<span class="w"> </span>cmudict.g2lex<span class="w"> </span>--format<span class="w"> </span>cmudict
