---
layout: tool-doc
title: "g2lex Benchmarking"
permalink: /tools/g2lex/main/benchmarking/
nav_tool: g2lex-main
docs_project: "g2lex"
docs_variant: "main"
docs_ref: "main"
...
<h1>Benchmarking</h1>
<p>Benchmarks are fixture-specific evidence, not a universal performance promise.
...
sequential iteration.</p>
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>python<span class="w"> </span>-m<span class="w"> </span>benchmarks.runtime_storage.benchmark<span class="w"> </span><span class="se">\</span>
<span class="w">  </span>tests/fixtures/generic.tsv<span class="w"> </span>--format<span class="w"> </span>tsv<span class="w"> </span>--repetitions<span class="w"> </span><span class="m">1000</span>
</pre></div>
</div>
<p>For binary or runtime refactors, record at least asset size, cold open/load,
...
benchmarking a partial download.</p>
<p>A structural improvement that causes a meaningful mmap or resident-memory
