---
layout: tool-doc
title: "kokorog2p Hebrew API"
permalink: /tools/kokorog2p/main/api/hebrew/
...
<section id="hebrew-api">
<h1>Hebrew API</h1>
<p>Hebrew G2P provides phoneme conversion using the phonikud package for handling Hebrew text with diacritics (nikud).</p>
...
<span class="n">g2p</span> <span class="o">=</span> <span class="n">HebrewG2P</span><span class="p">(</span><span class="n">language</span><span class="o">=</span><span class="s2">&quot;he-il&quot;</span><span class="p">)</span>
<span class="n">tokens</span> <span class="o">=</span> <span class="n">g2p</span><span class="p">(</span><span class="s2">&quot;שלום עולם!&quot;</span><span class="p">)</span>
...
<p>The Hebrew G2P implementation uses the phonikud package which:</p>
<ul class="simple">
<li><p>Handles Hebrew text with diacritics (nikud)</p></li>
<li><p>Converts Hebrew to IPA phoneme representation</p></li>
<li><p>Supports both modern and biblical Hebrew</p></li>
</ul>
<p>Reference: <a class="reference external" href="https://github.com/thewh1teagle/phonikud">https://github.com/thewh1teagle/phonikud</a></p>
</section>
</section>
</div>
