---
layout: tool-doc
title: "kokorog2p Swedish G2P"
permalink: /tools/kokorog2p/main/api/swedish/
...
<section id="swedish-g2p">
<h1>Swedish G2P</h1>
<p>Swedish is implemented as a native deterministic rule-based frontend.</p>
...
<span class="kn">from</span><span class="w"> </span><span class="nn">kokorog2p.sv</span><span class="w"> </span><span class="kn">import</span> <span class="n">phonemize_word_raw</span>

<span class="n">g2p</span> <span class="o">=</span> <span class="n">get_g2p</span><span class="p">(</span><span class="s2">&quot;sv&quot;</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="n">phonemize</span><span class="p">(</span><span class="s2">&quot;Hej världen!&quot;</span><span class="p">,</span> <span class="n">language</span><span class="o">=</span><span class="s2">&quot;sv&quot;</span><span class="p">)</span><span class="o">.</span><span class="n">phonemes</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="n">phonemize_word_raw</span><span class="p">(</span><span class="s2">&quot;sjuk&quot;</span><span class="p">)</span><span class="o">.</span><span class="n">ipa</span><span class="p">)</span>
</pre></div>
</div>
...
<p>This is a grapheme-to-pronunciation frontend. Swedish numbers, dates, units,
abbreviations, and spoken semantic normalization remain outside this module. Lexical and
loanword irregularities are expected limitations of a pure rule system.</p>
</section>
</div>
