---
layout: tool-doc
title: "kokorog2p Prepared phonemization"
permalink: /tools/kokorog2p/main/prepared_phonemization/
...
<h1>Prepared phonemization</h1>
<p>KokoroG2P is the phonological and model-adaptation layer. Its core APIs consume
<strong>prepared, speakable text</strong> plus an explicit language. They preserve that text as the
coordinate space for tokens, annotations, overrides, and results.</p>
...
<span class="n">result</span> <span class="o">=</span> <span class="n">phonemize_prepared</span><span class="p">(</span><span class="s2">&quot;Version two point oh.&quot;</span><span class="p">,</span> <span class="n">language</span><span class="o">=</span><span class="s2">&quot;en-us&quot;</span><span class="p">)</span>
</pre></div>
</div>
<p>The core does not verbalize numbers, abbreviations, units, currencies, dates, times,
...
<code class="docutils literal notranslate"><span class="pre">phonemize_prepared()</span></code>.</p>
<section id="linguistic-annotations">
<h2>Linguistic annotations</h2>
<p>Applications can inject analysis results without making KokoroG2P import the analysis
package. Objects need <code class="docutils literal notranslate"><span class="pre">start</span></code>, <code class="docutils literal notranslate"><span class="pre">end</span></code>, and may provide <code class="docutils literal notranslate"><span class="pre">text</span></code>, <code class="docutils literal notranslate"><span class="pre">pos</span></code>, <code class="docutils literal notranslate"><span class="pre">tag</span></code>, <code class="docutils literal notranslate"><span class="pre">lemma</span></code>, and
...
<span class="n">annotations</span> <span class="o">=</span> <span class="p">[</span>
    <span class="n">TokenAnnotation</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">6</span><span class="p">,</span> <span class="s2">&quot;record&quot;</span><span class="p">,</span> <span class="n">pos</span><span class="o">=</span><span class="s2">&quot;NOUN&quot;</span><span class="p">,</span> <span class="n">tag</span><span class="o">=</span><span class="s2">&quot;NN&quot;</span><span class="p">,</span> <span class="n">lemma</span><span class="o">=</span><span class="s2">&quot;record&quot;</span><span class="p">)</span>
<span class="p">]</span>
...
<p>Offsets are half-open source offsets. They must be ordered, non-overlapping, within the
...
configured spaCy model for that call.</p>
</section>
...
<p>Remove semantic preparation flags such as <code class="docutils literal notranslate"><span class="pre">input_mode</span></code>, <code class="docutils literal notranslate"><span class="pre">migrated_semantics</span></code>, and
<code class="docutils literal notranslate"><span class="pre">enable_context_detection</span></code>. Remove abbreviation registry calls and number/abbreviation
expansion options. Prepare the source text in the owning application or cross-package
pipeline, then pass the prepared result to <code class="docutils literal notranslate"><span class="pre">phonemize_prepared()</span></code> with its explicit
language.</p>
</section>
</section>
</div>
