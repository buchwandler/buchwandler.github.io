...
<section id="lexhint">
<h1>Lexhint</h1>
<p>Lexhint is a local lexical-evidence engine backed by self-describing SQLite artifacts.</p>
<p>It provides lexical membership, frequency enrichment, compact-string segmentation, stable semantic-domain evidence, and optional rich dictionary entries. It does not speak or normalize text.</p>
...
<li class="toctree-l2"><a class="reference internal" href="architecture/#id1">Business Context</a></li>
<li class="toctree-l2"><a class="reference internal" href="architecture/#id2">Technical Context</a></li>
</ul>
</li>
...
<li class="toctree-l2"><a class="reference internal" href="architecture/#consumer-interface">Consumer interface</a></li>
</ul>
</li>
...
<li class="toctree-l1"><a class="reference internal" href="architecture/#architecture-decisions">Architecture Decisions</a></li>
